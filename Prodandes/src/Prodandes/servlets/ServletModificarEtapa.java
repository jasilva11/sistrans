...
{	
	...
	private void imprimirEncabezado( HttpServletResponse response ) throws IOException
	{
		...
		out.println("<p>Esta es la operación que indica a ProdAndes que una etapa de producción, correspondiendo a un pedido de un cliente, se va a ejecutar en una estación de producción.</p>");
		out.println("</div>");
