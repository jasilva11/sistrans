...
{	
	...
	private void imprimirEncabezado( HttpServletResponse response ) throws IOException
	{
		...
		out.println("</div>");
		out.println("<p><h4><a href=\"buscarMaterialForm.htm\"><FONT SIZE=5>Buscar material</font></a></h4></p>");
		out.println("<p><h4><a href=\"buscarOperarioProductivo.htm\"><FONT SIZE=5>Buscar operario mas productivo</font></a></h4></p>");
		out.println("<p>&nbsp;</p>");
		out.println("</body>");
		out.println("</html>");
	}
