...
public class ServletEtapasProduccionMayorMovimiento extends HttpServlet
{	
	...
	private void imprimirEncabezado( HttpServletResponse response ) throws IOException
	{
		...
		out.println("        <blockquote>");
		out.println("          <blockquote>");
		out.println("            <h1>De un rango de fechas Y-M-D</h1>");
		out.println("            <p>.</p>");
		out.println("          </blockquote>");
		out.println("        </blockquote>");
		out.println("      </blockquote>");
		...
		out.println("  </blockquote>");
		out.println("</blockquote>");
		out.println("<form id=\"form1\" name=\"form1\" method=\"post\" action=\"rangoDeFechasEfectivo.htm\">");
		out.println("  <p>");
		out.println("    <label for=\"nombre2\"> Fecha Inicial:</label> ");
		out.println("      <input type=\"text\" name=\"nombre\" nombre=\"nombre2\" />");
		out.println("  </p>");
		out.println("  <p>");
		out.println("    <label for=\"antiguedad2\"> Fecha Final:</label> ");
		out.println("      <input type=\"text\" name=\"antiguedad\" antiguedad=\"antiguedad2\" />");
		out.println("  </p>");
		out.println("  <p>");
