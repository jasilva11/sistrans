...
public class ServletConsultarEtapasProduccion extends HttpServlet
{	
	...
	private void imprimirEncabezado( HttpServletResponse response ) throws IOException
	{
		...
		out.println("");
		out.println("<body>");
		out.println("<p>  <img src=\"imagenes/xVyoSl.jpg\" width=\"391\" height=\"300\" /> </p>");
		...
		out.println("  </blockquote>");
		out.println("</blockquote>");
		out.println("<form id=\"form1\" name=\"form1\" method=\"post\" action=\"ServletRegistroEfectivo.htm\">");
		out.println("  <p>");
		out.println("    <label for=\"nombre2\"> Nombre:</label> ");
		out.println("      <input type=\"text\" name=\"nombre\" nombre=\"nombre2\" />");
		out.println("  </p>");
		out.println("  <p>");
		out.println("    <label for=\"antiguedad2\"> Antiguedad:</label> ");
		out.println("      <input type=\"number\" name=\"antiguedad\" antiguedad=\"antiguedad2\" />");
		out.println("  </p>");
		out.println("  <p>");
		out.println("    <label for=\"deudas2\"> Deudas:</label> ");
		out.println("      <input type=\"number\" name=\"deudas\" deudas=\"deudas2\" />");
		out.println("  </p>");
		out.println("    <label for=\"nomRL2\"> Nombre del Representante Legal:</label> ");
		out.println("      <input type=\"text\" name=\"nombRL\" nombRL=\"nomRL2\" />");
		out.println("  </p>");
		out.println("  <p>");
		out.println("    <label for=\"numRSNV2\"> Numero de Registro ante Superintendencia Nacional de Valores:</label> ");
		out.println("      <input type=\"number\" name=\"numRSNV\" numRSNV=\"numRSNV2\" />");
		out.println("  </p>");
		out.println("    <label for=\"ciudad2\"> Ciudad:</label> ");
		out.println("      <input type=\"text\" name=\"ciudad\" ciudad=\"ciudad2\" />");
		out.println("  </p>");
		out.println("  <p>");
		out.println("    <label for=\"direccion2\"> Direccion:</label> ");
		out.println("      <input type=\"text\" name=\"direccion\" direccion=\"direccion2\" />");
		out.println("  </p>");
		out.println("  <p>");
		out.println("    <label for=\"telefono2\"> Telefono:</label> ");
		out.println("      <input type=\"text\" name=\"telefono\" telefono=\"telefono2\" />");
		out.println("  </p>");
		out.println("  <p>");
		out.println("    <label for=\"id2\"> Identificacion:</label> ");
		out.println("      <input type=\"text\" name=\"id\" id=\"id2\" />");
		out.println("  </p>");
		out.println("  <p>");
		out.println("    <label for=\"tpID2\"> Tipo de Identificacion:</label> ");
		out.println("      <input type=\"text\" name=\"tpID\" tpID=\"tpID2\" />");
		out.println("  </p>");
		out.println("  <p>");
		out.println("  <p>");
