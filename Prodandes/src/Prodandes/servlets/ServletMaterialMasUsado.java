...
public class ServletMaterialMasUsado extends HttpServlet
	{
		 ...
		 */
		private void imprimirEncabezado( HttpServletResponse response, MateriasPrimas resultado ) throws IOException
		{
			...
			out.println("</div>");
					out.println("    <FONT SIZE=5><label for=\"categoria2\"><strong> Nombre: "+ resultado.darNombre() + "</strong></label>");
					out.println("  </p>");
					out.println("    <label for=\"categoria2\"> Lo componen: "+ resultado.darComponentes() + "</label> ");
					out.println("  </p>");
					out.println("    <label for=\"categoria2\"> Compone: "+ resultado.darCompone() + "</label> ");
					out.println("  </p>");
					out.println("    <label for=\"categoria2\"> Producto: "+ resultado.darProducto() + "</label> ");
					out.println("  </p>");
					out.println("  <p>&nbsp;</p>");
					out.println("  <p>&nbsp;</p>");		
			out.println("<p>&nbsp;</p>");
