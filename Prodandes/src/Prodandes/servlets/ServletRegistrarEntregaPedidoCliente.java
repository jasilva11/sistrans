...
public class ServletRegistrarEntregaPedidoCliente extends HttpServlet
{	
	...
	private void imprimirEncabezado( HttpServletResponse response ) throws IOException
	{
		...
		out.println("        <blockquote>");
		out.println("          <blockquote>");
		out.println("            <h1>Registrar Entrega</h1>");
		out.println("            <p>.</p>");
		out.println("          </blockquote>");
		out.println("        </blockquote>");
		out.println("      </blockquote>");
		...
		out.println("  </blockquote>");
		out.println("</blockquote>");
		out.println("<form id=\"form1\" name=\"form1\" method=\"post\" action=\"servletEntregaProducto.htm\">");
		out.println("  <p>");
		out.println("    <label for=\"usr2\"> Usuario:</label> ");
		out.println("      <input type=\"text\" name=\"usr\" usr=\"usr2\" />");
		out.println("  </p>");
		out.println("  <p>");
		out.println("    <label for=\"pass2\"> Contraseña:</label> ");
		out.println("      <input type=\"text\" name=\"pass\" pass=\"pass2\" />");
		out.println("  </p>");
		out.println("  <p>");
		out.println("    <label for=\"nomp2\"> Nombre Producto:</label> ");
		out.println("      <input type=\"text\" name=\"nomp\" nomp=\"nomp2\" />");
		out.println("  </p>");
		out.println("  <p>");
		out.println("    <label for=\"asd2\"> Unidades Entregadas:</label> ");
		out.println("      <input type=\"text\" name=\"asd\" asd=\"asd2\" />");
		out.println("  </p>");
		
		
		
			
		out.println("    <input type=\"submit\" name=\"button\" id=\"button\" value=\"RegEntrega\" />");
		out.println("  </p>");
		out.println("</form>");
		out.println("<p>&nbsp;</p>");
		out.println("</body>");
