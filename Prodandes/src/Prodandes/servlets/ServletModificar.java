...
{	
	...
	private void imprimirEncabezado( HttpServletResponse response ) throws IOException
	{
		...
		out.println("<p>Modifique aqui los datos existentes o agregue unos nuevos.</p>");
		out.println("</div>");
		out.println("<p><h4><a href=\"servletModificarEtapa.htm\"><FONT SIZE=5>Registrar etapa de produccion</font></a></h4></p>");
		out.println("<p><h4><a href=\"#\"><FONT SIZE=5>Registrar llegada de material</font></a></h4></p>");
		out.println("<p><h4><a href=\"registrarPedidoProducto.htm\"><FONT SIZE=5>Registrar pedido producto</font></a></h4></p>");
		out.println("<p>&nbsp;</p>");
		out.println("</body>");
		out.println("</html>");
	}
