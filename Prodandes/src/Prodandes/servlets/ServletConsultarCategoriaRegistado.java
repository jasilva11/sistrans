...
public class ServletConsultarCategoriaRegistado extends HttpServlet
{	
	...
	private void imprimirEncabezado( HttpServletResponse response ) throws IOException
	{
		...
		out.println("");
		out.println("<body>");
		out.println("<h3>Buscar</h3>");
		out.println("<p>Realice aqui sus busquedas relacionandas a las empresas.</p>");
		out.println("<a href=\"#\" class=\"green-btn\">Buscar Materiales</a>");
		out.println("</div>");
		out.println("<form id=\"form1\" name=\"form1\" method=\"post\" action=\"ConsultarCargaEfectiva.htm\">");
		out.println("  <p>");	
		out.println("    <label for=\"categoria2\">Categoria:</label> ");
		out.println("      <input type=\"text\" name=\"categoria\" id=\"categoria2\" />");
		out.println("  </p>");
		out.println("  <p>");
		out.println("    <label for=\"numero\">Numero memes:</label>");
		out.println("    <input type=\"text\" name=\"numero\" id=\"numero\" />");
		out.println("  </p>");
