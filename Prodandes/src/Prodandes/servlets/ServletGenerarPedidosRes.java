	...
	private void imprimirEncabezado( HttpServletResponse response, ArrayList resultados, String producto ) throws IOException
	{
		...
		for (int i = 0; i < resultados.size(); i++) 
		{
			if (resultados.get(i) != null)
			{
				...
				out.println("<form id=\"form1\" name=\"form1\" method=\"post\" action=\"crearPedido.htm\">");
				...
				out.println("<input type=\"text\" name=\"id\" value=\""+ x.getIdentificacion() +"\">");
				out.println("  </p>");
				...
				out.println("  </p>");
				out.println("    <label for=\"categoria2\"> Material: </label> ");
				out.println("<input type=\"text\" name=\"material\" value=\""+ x.darMaterial() +"\">");
				out.println("  </p>");
				out.println("    <label for=\"categoria2\"> Volumen Compra: </label> ");
				out.println("<input type=\"text\" name=\"volumen\" value=\""+ x.darVolumen() +"\">");
				out.println("  </p>");
				out.println("    <label for=\"categoria2\"> Tiempo Entrega (semanas): </label> ");
				out.println("<input type=\"text\" name=\"tiempo\" value=\""+ x.darTiempo() +"\">");		
				out.println("  </p>");	
				out.println("    <label for=\"categoria2\"> Costo: </label> ");
				out.println("<input type=\"text\" name=\"costo\" value=\""+ costo +"\">");
				out.println("  </p>");	
				out.println(" <input type=\"submit\" name=\"button\" id=\"button\" value=\"Hacer pedido\" />");
				out.println(" </p>");
				out.println(" </form>");
				out.println("  <p>&nbsp;</p>");
				out.println("  <p>&nbsp;</p>");
