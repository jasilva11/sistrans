...
public class ServletRF12 extends ServletTemplate {
	...
	public void escribirContenido( HttpServletRequest request, HttpServletResponse response ) throws IOException
	{
		...
		if(prodAndes.getInstance().getRF12()==null)
		{
			prodAndes.getInstance().inicRF12();
		...
		else
		{
			...
			if(h.trim().equals("sigue"))
			{
				...
				ArrayList<ProductoPedido> r=prodAndes.getInstance().getRF12();
			...
			else if(h.equals("termino"))
			{
				...
				PedidoCliente r= prodAndes.getInstance().terminarRF12(request.getParameter("fecha"));
				if(r!=null)
				{
				out.println("				<section id=\"intro\" class=\"container\" style=\"alingment:center;\">");
				out.println("					<div class=\"panel-body\">");
